...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *TechCafe.Api*):
...
Execute unit tests
```
    cd "TechCafe.Api/test/TechCafe.Api.Tests"
    dotnet test
```

Deploy application
```
    cd "TechCafe.Api/src/TechCafe.Api"
